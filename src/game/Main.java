...
public class Main {
	...
	public Main() {
		...
		Gui gui_lives = new Gui(sheet, window);
		...
		while (!window.shouldClose()) {
			...
			if (can_render) {
				...
				gui_lives.render(heart_01_pos, 0);
				gui_lives.render(heart_02_pos, 0);
				gui_lives.render(heart_03_pos, 0);
				// gui_button.render();
